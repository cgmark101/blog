...
This is the source code for a blog, made with flask, it use a markdown pattern for the blog posts, can be dynamically generated or statically build using froze-flask
...
![akane.ga_mobile](https://cdn.jsdelivr.net/gh/cgmark101/CDN-stuff@main/dist/img/akane.ga_(iPad).jpg =550x1304)
